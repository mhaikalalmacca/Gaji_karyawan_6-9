        ...
        <div class="col-md-4 mb-4">
          <div class="card h-100 shadow-sm">
            ...
            <div class="card-footer d-flex justify-content-between">
              <a href="forms/detail_karyawan-1.php?id=<?= $row['id'] ?>&from=dashboard" class="btn btn-info btn-sm">Detail</a>
              <a href="forms/edit_karyawan-1.php?id=<?= $row['id'] ?>" class="btn btn-warning btn-sm">Edit</a>
              <a href="forms/hapus_karyawan-1.php?id=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin ingin menghapus?')">Hapus</a>
            </div>
          </div>
        </div>
      <?php endwhile; ?>
